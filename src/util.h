...
inline CScript PlatformScript() {
      CDONUAddress cda = CDONUAddress(Params().PlatformAddress());
      CScript platformScript = GetScriptForDestination(cda.Get());
...
{
    std::string s = strprintf("donu-%s", name);
