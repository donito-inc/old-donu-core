This directory contains the DONUQT graphical user interface (GUI). It uses the cross-platform framework [Qt](https://www1.qt.io/developers/).
...
Represents the main window of the DONU UI.
...
* UI elements like DONUAmountField, which inherit from QWidget.
* `bitcoinstrings.cpp`: automatically generated
* `bitcoinunits.(h/cpp)`: DONU / mDONU / etc handling
* `callback.h`
