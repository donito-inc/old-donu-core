...
/** DONU unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DONUUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DONUUnits(QObject *parent);
...
typedef DONUUnits::Unit DONUUnit;
