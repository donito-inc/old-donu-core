...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<DONUAmountField*>("payAmount")->setValue(amount);
    /*
...
void TestGUI()
{
    ...
    QString balanceComparison = DONUUnits::formatWithUnit(unit, balance, false, DONUUnits::separatorAlways);
    ...
    // Amount input
    DONUAmountField* amountInput = receiveCoinsDialog.findChild<DONUAmountField*>("reqAmount");
