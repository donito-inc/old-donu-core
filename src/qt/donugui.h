...
/**
  DONU GUI main class. This class represents the main window of the DONU UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class DONUGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit DONUGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~DONUGUI();
