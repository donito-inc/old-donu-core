    ...
    mapper(0)
{
    ...
    ui->openDONUConfButton->setToolTip(ui->openDONUConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new DONUUnits(this));
...
void OptionsDialog::on_openDONUConfButton_clicked()
{
